...
module.exports = {
  meta: {
    ...
    messages: {
      [PUBLIC_ERROR]:
        'Absolute import is allowed only from public API (index.js/ts)',
      [TESTING_PUBLIC_ERROR]:
        'Test data need import from public API file for tests (testing.js/ts) only in files from testFilesPatterns option',
      [NEED_FROM_PUBLIC_ERROR]:
        'Must be imported from a public API file (index.js/ts)',
    },
    docs: {
